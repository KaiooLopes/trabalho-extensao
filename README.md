...
1. **Instale o Node.js**  
   Versão LTS recomendada: https://nodejs.org/

2. **Instale o Expo CLI (global):**
   ```bash
...
5. **Abra o app no celular com o Expo Go:**
   - Instale o app **Expo Go** na Play Store ou App Store.
   - Escaneie o QR Code que aparece no terminal ou na página do Expo.
